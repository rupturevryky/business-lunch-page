    ...
    for (let i = 0; i < localStorage.length; i++) {
        ...
        now_order.innerHTML =
            `
                ...
                <p class="leng_250">Дата оформления</p>
                <p class="leng_400">Состав заказа</p>
                <p class="leng_150">Стоимость</p>
                <p class="leng_200">время доставки</p>
                <p class="leng_100">
